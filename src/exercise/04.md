...
- derive state based on squares array
 -- nextvalue, winner, status are derived based on what is inside the square arrray
- start from finished UI helps figure out logic
## Background
...
Fill out
[the feedback form](https://ws.kcd.im/?ws=React%20Hooks%20%F0%9F%8E%A3&e=04%3A%20useState%3A%20tic%20tac%20toe&em=tdanh%40spawar.navy.mil).
