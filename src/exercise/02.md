...
* useEffect dependency array only does shallow comparisons. Objects trigger a useEffect every rerender. // === Object.is

* custom hooks - extract logic from component and reuse it anywhere we want to use it again in another component. custom hooks starts with use and can use other hooks in it.
...
Fill out
[the feedback form](https://ws.kcd.im/?ws=React%20Hooks%20%F0%9F%8E%A3&e=02%3A%20useEffect%3A%20persistent%20state&em=tdanh%40spawar.navy.mil).
